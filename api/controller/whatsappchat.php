<?php
// Include Deals Model
require_once "model/whatsappchat.php";
require_once "model/login.php";
class WHATSAPPCHAT extends WHATSAPPCHATMODEL
{
    public function whatsappchatCtrl($request, $tokenParms)
    {
        try {
...
$classActivate = new WHATSAPPCHAT();
// Reponse for the request
$classActivate->whatsappchatCtrl($data, $token);
