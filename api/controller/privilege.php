...
class PRIVILEGE extends PRIVILEGEMODEL
{
    public function PrivilegeCtrl($request, $tokenParms)
    {
        try {
...
$classActivate = new PRIVILEGE();
// Reponse for the request
$classActivate->PrivilegeCtrl($data, $token);
